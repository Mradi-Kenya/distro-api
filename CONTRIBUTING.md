...
Anyone can open a pull request on Distro API. You do not need to work at Mradi Kenya or be a member of the org to open a pull request.

1. Fork and clone [this repository](https://github.com/Mradi-Kenya/distro-api.git).
